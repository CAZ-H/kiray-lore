...
Due to Kiray's high humidity reducing the efficacy of evaporative cooling, heat is the main constraint upon Kirian physiology. Through the long afternoon in the equatorial band, where the temperatures are warmest, the air is warmer than most organisms' core body temperature, so they absorb heat above their core temperature rather than shed it. Also, metabolic rate climbs steeply with body temperature, roughly doubling for every 10 degrees.  This means on hot days, bodies run hot and burn calories and oxygen at a high rate, which works the heart hard and accumulates cellular stress. This causes high temperatures to reduce the natural lifespan of Kirian organisms, and cool temperatures to extend their natural lifespans at the expense of a greater appetite. 
