...
**Vestigial Arms:** A secondary pair of smaller limbs rests folded against the upper chest. Though lacking full joint articulation, they are capable of basic gripping and manipulation. Each ends in two clawed digits, with reduced nub-like immobile thumb structures. These arms are typically used for carrying small objects, and are not capable of fine manipulation.

**Legs:** Skiedons are digitigrade. Each foot has elongated metatarsals, punctuated with three forward-facing toes and one rear-facing toe, forming a grasping arc capable of stabilizing the body during climbs or jumps or gripping branches securely. Each toe ends with a prominent claw. Leg musculature is tuned for burst movement and vertical propulsion. However, this foot configuration is not adapted for walking or running long distances with ease.

**Tail:** The spine includes a reinforced tail root that integrates into the lower pelvis and supports a fully prehensile tail, terminating in a gripping appendage with anchoring claws, used to wrap around branches or hold objects during locomotion. The tail is muscular and highly flexible, extending nearly the full length of the body.
...
**Respiratory Spiracles:** Skiedons breathe through facial spiracles embedded in the frontal skull and partially recessed into the base of the beak. These spiracles draw in air via internal cartilage scoops, which is filtered via an internal structure that drains to the back of the throat. These spiracles are also responsible for primary olfaction.

**Brow Crests:** From the cranial ridge, along the brow of the eyes, a bony ridge sweeps backward in a curved arc, varying in length by genetic disposition. These bony structures are semi hollow inside and serve to amplify high frequency sound which is muffled by vegetation within forests. The shape of these ridges is highly hereditary and can be used to identify lineages.
...
Skiedons do not regulate their temperature with their skin, and do so in other ways, such as panting, seeking shade, and bathing.

Skiedon blood is usually light blue due to hemocyanin presence, which is generally reflected in their skin color, but some Skiedons have stronger skin pigmentation than others, which is hereditary. Natural skin coloration is usually light to reflect sunlight and help with thermoregulation, and typically ranges from blue to violet with greenish or purplish undertones depending on genetics, historical sun exposure and diet. The dorsal scales are almost always darker or more saturated than the skin due to the thickened scales containing more pigment.

As historical sun exposure increases, Skiedons will experience darkening of their scales to protect against UV exposure, however, this increases sunlight absorption and thus body heat, ultimately reducing their ability to tolerate being outside under the hot sun without regulation. These color changes occur independently of shedding as they happen on the inner layers of the skin. After multiple sheds in a different environment, scale color can gradually return to its natural lighter color. Green shades only express when there has been very limited sun exposure and the Skiedon is genetically predisposed to it, making them exceedingly rare.
...
**Respiratory System:** Skiedons breathe through a set of symmetrical lungs supported by internal buffered air sacs that act as bellows to keep air moving in one direction, rather than in and back out, allowing for a steady flow of fresh air over the lung structures so oxygen is absorbed efficiently. Carbon dioxide moves out into the airflow and is exhaled past a vocal structure inside of the throat which can vibrate to produce various sounds. This one-way air flow keeps the lungs constantly supplied with oxygen-rich air, so they never fully empty out during an exhale. As a Skiedon breathes in through the spiracles above its beak, it fills the first chamber of the air sacs; simultaneously it is exhaling from the second chamber of the air sacs, through the lung structures, and out through the mouth; between breaths there is a short pause as the air in the air sacs transfer chambers. A consequence of this design is that Skiedons are capable of long sustained sounds, and speech can be fluid with little need for pause. Heavy physical activity can also force the air sacs that feed the lungs to pump air more aggressively as the Skiedon moves its shoulders, recycling the effort expended during brief bursts of intense activity, providing an oxygen boost.
...
- Average lifespan is ?? cycles, with the oldest Skiedons respected as navigators and storytellers.
- Injuries from falls, hunting accidents, or predation are common but treated with communal care.
