...
The arms are muscular, each with joints that form a shoulder, elbow, and wrist. They are held folded against the upper body when not in use. The hands host three segmented, fully opposable armored fingers that come together to form a tri-pronged claw. The palms are distorted with thick muscle allowing the claws to exert tremendous crushing force.
...
As they age, Zorn gradually develop more sophisticated thought patterns. Unlike the conventional notion of an intelligent species, their sense of creativity and their abstract reasoning abilities remain stunted throughout their lives. They possess little capacity for innovation, and complex technologies remain largely inscrutable to them. However, their intelligence manifests through a strong ability to observe, imitate, and adapt. They excel at learning not through understanding, but through practice and pattern recognition. The Zorn take centuries to make technological advancements, favoring tradition and only stumbling upon new ways to use their world either by accident, or when an unusually clever Zorn emerges.

Zorn are natural strategists. Their strength lies in social manipulation, hierarchical control, and the use of brute force problem-solving. Though they may not understand the underlying principles of a dynamic system or a piece of technology, they can recognize patterns and discern how to influence it or wield it effectively. This practical understanding of the world allows them to operate advanced technology through memorized routines. With lifespans stretching several centuries, individual Zorn can amass an immense amount of practical experience and wisdom, learning through trial and error. Over time, elder Zorn become invaluable repositories of functional knowledge, and will dedicate their final years to educating the next generation.
...
The Elder Ring is responsible for setting goals, handling external relations, navigating external conflict, managing resources, and handling internal disputes. They also serve as the primary educators for younger Zorn, passing down hard-earned knowledge through direct instruction and practice. Though the elders share leadership, there is often an unspoken hierarchy within the council, with the most respected elder wielding subtle influence over the group. However, any attempt to seize outright control is typically met with unified opposition, as stability is valued over individual ambition.

Within the tribe, roles are assigned based on age, experience, and proven capability. Juvenile Zorn, whose cognitive development is still limited, perform labor or take the frontline in hunting parties or in combat. Their raw aggression is channeled into useful work, ensuring that their destructive impulses benefit the tribe. As they mature, Zorn are granted more complex responsibilities, including resource gathering and processing, construction, and limited leadership roles under the guidance of the Elder Ring. Rowdy juvenile Zorn are subdued by the tribe through physical intervention, and isolated for short periods as needed. On the homeworld, this was typically done using pits in the ground.

Interactions between tribes are typically fraught with tension. While the Elder Ring promotes stability within the tribe, external relations are often handled with suspicion and opportunism. Tribes occasionally form temporary alliances when faced with common threats, but these alliances are fragile and typically last only as long as they are mutually beneficial. Trade between tribes is rare and often conducted under strict terms, with each side wary of exploitation.
...
When the Zorn left their homeworld, they were forced to adapt their tribal way of life to fit aboard their small initial fleet of ships. The Elder Ring maintained its pivotal role, directing expeditions to scavenge resources, conquer new territories, and enslave other species to sustain their technology and resources. Gradually, new Elder Rings emerged on individual spacecraft and tribal hierarchy re-emerged, however due to the pressures of survival as galactic nomads, they were forced to agree upon a central authority of elders whose role was to guide the Zorn towards their ultimate goal; finding a new homeworld. With this ultimate goal in mind, the Zorn travel through space together, but spread far apart. While individual tribes typically avoid each other, they occasionally come together for important planetary assaults. These temporary coalitions of tribes can unleash massive assaults capable of destroying entire civilizations, though they inevitably dissolve once the spoils are divided.

Individual tribes participate in their own smaller-scale skirmishes and raids as they see fit, but the central Elder Ring also often directs much larger raids and abductions on habitable planets. These raids often start with an ultimatum delivered to a sentient species to ideally force compliance in order to try and preserve their limited resources, but the execution of the ultimatum is always swift and devastating, focused on capturing resources and living beings with minimal expenditure of their own. Civilizations that have heard of the Zorn are never the same afterwards.

But despite their savagery, the Zorn are not reckless. The Elder Ring tempers their aggression with strategy, knowing that wastefulness leads to weakness. The Zorn will preemptively retreat if there is the chance they are outmatched, but will fiercely defend each and every one of their own ships should a crisis arise.

Over time, Zorn ships became massive, cobbled-together vessels built from multiple smaller ships, salvaged materials, and captured technology. Each ship functions as a mobile tribe, with an Elder Ring at the helm. The ships themselves are labyrinthine due to their haphazard construction, roughly designed with slave management in mind, featuring choke points, integrated behavior enforcement technology, and many layers of redundancy to offset the impact of slave misbehavior. Ship interiors are utilitarian, with spaces designated for food processing, weapon storage, the containment of enslaved populations, social rituals, and general living.
...
**The Core (Zorn Occupied):** The oldest and most structurally sound sections, reserved exclusively for the Zorn and a few personal servants. This area houses living quarters, command centers, ritual spaces, and is heavily guarded. Access is strictly prohibited to all but the most trusted slave personnel under direct Zorn supervision.

**Weapon Systems & Combat Control:** Heavily armored sections housing stolen and modified weaponry. Operated by Zorn warriors, with enslaved technicians maintaining the systems under strict supervision.

**Containment & Control Zones:** Grim, heavily guarded areas dedicated to isolating rebellious yet valuable slaves, conducting "behavioral adjustments", administering healthcare, and processing bodies for consumption or disposal. These zones are shrouded in secrecy.

**Engineering & Maintenance Sectors:** The largest and most hazardous zones, a tangled network of corridors and warehouse spaces, machinery, and assorted salvage. The majority of enslaved engineers, technicians, and laborers are confined to these areas. Conditions are perpetually noisy, dimly lit, and rife with environmental hazards.

**Resource Processing & Storage:** Dedicated to refining raw materials (mined from asteroids, salvaged from planets or ships, or extracted from biological sources), processing food, and storing supplies.
...
**Engineers/Technicians:** Highly valued for their ability to maintain and repair the ship's complex systems. However, they are closely monitored and prevented from making unauthorized modifications. Their knowledge is seen as a tool, not a talent.

**Biologists/Medics:** Used to maintain the health of the Zorn and other slaves, but also often forced to perform various surgeries on slaves, such as body modification and cybernetic implant installation.

**Servants:** Assigned menial tasks like grooming or providing rudimentary entertainment for the Zorn. They often face additional abuse and exploitation, but are generally treated to more comfortable lives. For the most part, the Zorn see servants as one might see a pet, however the Zorn generally have no emotional attachment to their servants.

**Laborers:** The most numerous caste, performing manual labor, resource processing, and waste disposal. Treated as entirely expendable, and are sometimes made more docile with surgery.
...
**The Overseer System:** Each group of slaves is overseen by a Zorn overseer, typically a younger Zorn proving their dominance. Overseers enforce quotas, punish disobedience, and report rebellion. They are granted considerable authority and encouraged to be brutal.

**Behavioral Control:**
- *Pain/Death Inducement Technology:* Various types of collars, cuffs, and implants that can deliver punishment passively, actively, or remotely. Most slaves receive at minimum a crudely reproduced collar that can be remotely activated.
- *Mental Dampening:* Surgery intended to suppress emotion and personality, rendering slaves apathetic and reducing complex cognitive function. This technique is used exclusively on slaves that perform simple physical tasks.
- *Speech Jammers:* Implants that disrupt the ability to produce language or otherwise communicate. The Zorn cannot easily reproduce this technology, so it is exclusively used and reused for valuable slaves who are prone to plotting.

**Quotas & Incentives:** Slaves are assigned strict quotas. Meeting quotas may result in slightly improved rations or a temporary reprieve from abuse. Failure results in severe punishment.
